...
| More robust developer tools|Add recursiveCopy & recursiveDelete to rdflib; help make query-ldflex available outside the browser; support in-browser pod storage via localStorage and Cache | Jeff Zucker | https://github.com/jeff-zucker/
